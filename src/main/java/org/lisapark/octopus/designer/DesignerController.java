...
public class DesignerController {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(DesignerController.class);
    // todo other services
    ...
    public DesignerController(ProcessingModel model, ProcessorService processorService,
